...
| 数据项 | 数值 | 来源 |
| ------ | ---- | ---- |
| USDC/USDT ratio | 0.449→0.451，变化+0.002 | 05-scoring-rubric.md 综合计分示例 |
| USDC market share 4周变化 | +0.2 ppt（横盘） | 05-scoring-rubric.md 综合计分示例 |
| RLDC margin（Q1 2026） | 40.3% | 05-scoring-rubric.md 综合计分示例 |
| Base USDC 占比 | 32% | 05-scoring-rubric.md 综合计分示例 |
| USDT dominance 4周变化 | +0.8 ppt（未超1 ppt） | 05-scoring-rubric.md 综合计分示例 |
| 收益型产品AUM 周环比 | +13% | 05-scoring-rubric.md 综合计分示例 |
| USDC 当周净铸造 | +3亿美元 | 05-scoring-rubric.md 综合计分示例 |
| Borrow 利用率 | 48% | 05-scoring-rubric.md 综合计分示例 |
| Adjusted transfer volume 4周MA | 上升+3.1% | 05-scoring-rubric.md 综合计分示例 |
| Active addresses 环比 | +1.2% | 05-scoring-rubric.md 综合计分示例 |
| GENIUS Act 状态 | 仍在审议，无正负面新事件 | 03-competition.md 资料链接 |
| 银行稳定币企业客户数 | <3个 | 05-scoring-rubric.md 综合计分示例 |
| Other revenue share | 5.5% | 05-scoring-rubric.md 综合计分示例 |
| Short interest | 9% | 05-scoring-rubric.md 综合计分示例 |
| 30D IV | 38% | 05-scoring-rubric.md 综合计分示例 |

**7维度正式打分（按05-scoring-rubric.md逐档执行）：**
...
**档位：中性偏强（55-74）**  
**当前结论：D3（RLDC margin 40.3%）是最强支撑维度；D1（市占横盘）和D2（USDT未见明显下行）是最关键边际变量；维持框架，等Q2 2026财报验证RLDC margin方向。**
...
| 2026年初 | 57.50 | 中性偏强 | 当前基准，待验证 | 🔲 进行中 |
...
> 当前估算值来源：Base USDC占比32%来自05-scoring-rubric.md综合计分示例（2026-05-01数据）；Coinbase products average USDC $19B+（占总USDC供应25%以上）来自Coinbase Q1 2026 results。
...
根据05-scoring-rubric.md（D5链生态健康）和archive/1.md的口径定义，**adjusted transfer volume** 的去洗量规则如下：
...
| 2026-05 | 待补充 | 待补充 | 待补充 | CoinMetrics | 当前基准 |
